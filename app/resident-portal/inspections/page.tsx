...
export default function ResidentInspectionsPage() {
  ...
  return <main className="min-h-screen bg-slate-50 p-4 sm:p-6 lg:p-8"><div className="mx-auto max-w-6xl space-y-6">
    <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm"><p className="text-sm font-semibold uppercase tracking-[0.2em] text-indigo-600">StayHub Resident Portal</p><h1 className="mt-2 text-3xl font-bold">My Inspections</h1><p className="mt-1 text-sm text-slate-500">View your room inspection history and condition findings.</p><Link href="/resident-portal" className="mt-4 inline-flex text-sm font-semibold text-indigo-700">Back to portal</Link></section>
